...
"""
   ...
   3. adding adjacency normalizaion L=D^-0.5 * (A+I) * D^-0.5, normally in evey batch, L = AXW, where A is normalized.
      in order to avoid batch look up to find batch-A, we convert AX = X in the initial step. now L = XW
